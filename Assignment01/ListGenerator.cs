...
namespace LINQ
{
    ...
    class Product02 : Product
    {
        ...
        public override string ToString()
            => $"Product02 serial is {SerialNumber}";
    ...
    internal static class ListGenerator
    {
        ...
        static ListGenerator()
        {
            ...
            {
                // i can change prodcut to be product02 because 02 inheriate from product
                new Product02() {ProductID = 1, ProductName = "Chai", Category = "Beverages",
                            UnitPrice = 18.00M, UnitsInStock = 100, SerialNumber = 580},
